...
public class FastdfsClientTest {
	...
	//客户端配置文件
	public String conf_filename = "F:\\Program Files\\feiq\\Recv Files\\fastdfsClient\\src\\cn\\itcast\\fastdfs\\cliennt\\fdfs_client.conf"; 
    //本地文件，要上传的文件
	public String local_filename = "G:\\图片\\17.jpg"; 
...
//                    storageServer); 
            ...
            byte[] b = storageClient.download_file("group1", 
                    "M00/00/00/rBABQ1nnrfKAYgKyACyEvD3-SJc641.pdf"); 
            if(b !=null){
            	 System.out.println(b.length); 
                 saveFile(b, "D:\\jiyun\\", "alei_test3.pdf"); 
            }
    ...
    public void testGetFileMate(){ 
        try { 
            ...
            StorageClient storageClient = new StorageClient(trackerServer, 
                    storageServer); 
            NameValuePair nvps [] = storageClient.get_metadata("group1", "M00/00/00/wKggGVK-By2AYSAVAADW-N057MA089_big.jpg"); 
            if(nvps!=null){
